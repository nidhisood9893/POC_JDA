...
namespace POC.Services
{
    ...
    public class MockDataStore : IDataStore<History>, ISummaryDataStore<Leaves>
    {
        ...
        public MockDataStore()
        {
            ...
            {
                new Leaves { Id = "EMP20148",EmployeeName="Jon Doe", CasualLeaves = 18,CompOffs=3,
                ...
                new Leaves { Id = "EMP20147",EmployeeName="Mathew Gonsalves", CasualLeaves = 18,CompOffs=4,
                ...
                new Leaves { Id = "EMP20146",EmployeeName="Nick", CasualLeaves = 18,CompOffs=2,
                ...
                new Leaves { Id = "EMP20145", EmployeeName="Sam",CasualLeaves = 18,CompOffs=3,
